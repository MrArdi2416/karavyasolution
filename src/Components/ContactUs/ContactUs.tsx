            ...
            <div className="max-w-xl mx-auto">
                <div className="text-center ">
                    ...
                    <p className="mb-16 text-base text-center text-gray-500">
                      Welcome to the KARAVYA SOLUTION PLEASE GET IN TOUCH WITH US 
                    </p>
                </div>
            </div>
                ...
                <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                    <div
                        ...
                        <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                            Email</h2>
                        <a href="#"
                            className="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">info@karavyasolutions.com</a>
                    </div>
                </div>
                <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                    <div
                        ...
                        <h2 className="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                            Phone</h2>
                        <a href="#"
                            className="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">+91 96010 70295</a>
                    </div>
                </div>
                <div className="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
                    <div
